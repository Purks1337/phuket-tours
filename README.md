...
- **`category`** (строка, обязательно) — категория экскурсии. От этого зависит, в каком блоке она появится. Основные категории: `🔥 ХИТЫ 🔥`, `МОРСКИЕ`, `НАЗЕМНЫЕ`, `ПО ПХУКЕТУ`, `ПО ПАТТАЙЕ`.
